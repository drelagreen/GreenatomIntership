...
public class MainControllerTest {
    ...
    public void filterMessageTest() throws Exception{
        this.mockMvc.perform(get("/main").param("filter","1tag"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/div/i").string("#new one"));
